...
class posenet_v1_hourglass4_relation_cat(Symbol):
    ...
    def get_stacked_hourglass(self, data, num_stack=4, in_dim=256, out_dim=68, increase_dim=128,
        ...
        for i in range(cfg.pose.head_num):
            ...
            # part_feat = mx.symbol.Custom(op_type='monitor_multivar', data_0=select_part_indices,data_1=data_reshape, data_2=part_feat, n=3, nickname="part_feat")
