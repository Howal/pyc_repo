...
class posenet_v1_hourglass4_relation_cat_sigmoid_th_norm_v2(Symbol):
    ...
    def relation_module(self, key_data, query_data, affinity_dim, value_dim, output_dim, num_part, top_k,
        ...
        aff_mat_sigmoid_masked = aff_mat_sigmoid * (aff_mat_sigmoid > self.cfg.pose.norm_th)
        aff_mat_norm = mx.sym.broadcast_div(aff_mat_sigmoid_masked, mx.sym.maximum(self.cfg.pose.norm_th, aff_mat_sigmoid_masked.sum(axis=-1, keepdims=True)))
    ...
    def get_stacked_hourglass(self, data, keypoint_location, keypoint_visible, num_stack=4, in_dim=256, out_dim=68, increase_dim=128,
        ...
        for i in range(cfg.pose.head_num):
            ...
            relation_feat, aff_mat_sigmoid = self.relation_module(key_data=part_feat, query_data=feature,
