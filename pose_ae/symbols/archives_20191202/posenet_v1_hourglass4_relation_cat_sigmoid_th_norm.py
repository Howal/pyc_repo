...
class posenet_v1_hourglass4_relation_cat_sigmoid_th_norm(Symbol):
    ...
    def relation_module(self, key_data, query_data, affinity_dim, value_dim, output_dim, num_part, top_k,
        ...
        norm_denominator = (aff_mat_sigmoid > self.cfg.pose.norm_th).sum(axis=-1, keepdims=True)
        norm_denominator = mx.sym.maximum(1, norm_denominator)
        aff_mat_norm = mx.sym.broadcast_div(aff_mat_sigmoid, norm_denominator)
