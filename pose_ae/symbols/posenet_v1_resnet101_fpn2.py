...
class posenet_v1_resnet101_fpn2(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        fpn_p2, fpn_p3, fpn_p4, fpn_p5, fpn_p6 = self.get_fpn_feature(c2, c3, c4, c5, feature_dim=256)

        fpn_p3_up = mx.symbol.UpSampling(fpn_p3, scale=2, sample_type='nearest', name='feat_p3_upsample')
        fpn_p4_up = mx.symbol.UpSampling(fpn_p4, scale=4, sample_type='nearest', name='feat_p4_upsample')
        fpn_p5_up = mx.symbol.UpSampling(fpn_p5, scale=8, sample_type='nearest', name='feat_p5_upsample')
        fpn_p6_up = mx.symbol.UpSampling(fpn_p6, scale=16, sample_type='nearest', name='feat_p6_upsample')
        data = mx.sym.concat(fpn_p2, fpn_p3_up, fpn_p4_up, fpn_p5_up, fpn_p6_up, dim=1, name='concat_fpn_feat')
